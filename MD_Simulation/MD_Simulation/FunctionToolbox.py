class FunctionToolbox(object):
    """Class that gives a list of function to calculate neighboors"""
import math
from Atom import *
...
def Compute_Neighboors(List_Atoms, Rc):
     for i in range(0,len(List_Atoms)):
        ...
        Atom_ref.Update_Neighboors(List_neighboors) 
